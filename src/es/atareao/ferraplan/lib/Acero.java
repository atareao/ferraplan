...
public class Acero  extends WrapperTable<Acero>{
    //
    //********************************CONSTANTES********************************
    //
    ...
    //******************************CONSTRUCTORES*******************************
    //
    public Acero() throws SQLException {
        this(null);
    }
     ...
     */
    public Acero(Conector conector) throws SQLException {
        super(Acero.class,conector, "public", "acero");
    ...
    //********************************METODOS***********************************
    //
    public Vector<Acero> view(Vector<Condition> conditions) throws SQLException {
        return this.find(conditions);
    }

    public Vector<Acero> view(Condition condition) throws SQLException {
    ...
    @Override
    public Vector<Acero> view() throws SQLException {
        Vector<Condition> conditions = new Vector<Condition>();
        return this.view(conditions);
    }
    @Override
