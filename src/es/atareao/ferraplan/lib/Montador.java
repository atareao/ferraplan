...
public class Montador  extends WrapperTable<Montador>{
    //
    //********************************CONSTANTES********************************
    //
     ...
     */
    public Montador(Conector conector) throws SQLException {
        super(Montador.class,conector, "public", "montador");
    ...
    //********************************METODOS***********************************
    //
    public Vector<Montador> view(Vector<Condition> conditions) throws SQLException {
        return this.find(conditions);
    }

    public Vector<Montador> view(Condition condition) throws SQLException {
    ...
    @Override
    public Vector<Montador> view() throws SQLException {
        Vector<Condition> conditions = new Vector<Condition>();
        return this.view(conditions);
    }
    @Override
