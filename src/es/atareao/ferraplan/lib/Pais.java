...
public class Pais  extends WrapperTable<Pais>{
    //
    //********************************CONSTANTES********************************
    //
    ...
    //******************************CONSTRUCTORES*******************************
    //
    public Pais() throws SQLException {
        this(null);
    }
     ...
     */
    public Pais(Conector conector) throws SQLException {
        super(Pais.class,conector, "public", "pais");
    ...
    //********************************METODOS***********************************
    //
    public Vector<Pais> view(Vector<Condition> conditions) throws SQLException {
        return this.find(conditions);
    }

    public Vector<Pais> view(Condition condition) throws SQLException {
    ...
    @Override
    public Vector<Pais> view() throws SQLException {
        Vector<Condition> conditions = new Vector<Condition>();
        return this.view(conditions);
    }
    @Override
