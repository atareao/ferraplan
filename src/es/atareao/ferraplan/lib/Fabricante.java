...
public class Fabricante  extends WrapperTable<Fabricante>{
    //
    //********************************CONSTANTES********************************
    //
     ...
     */
    public Fabricante(Conector conector) throws SQLException {
        super(Fabricante.class,conector, "public", "fabricante");
    ...
    //********************************METODOS***********************************
    //
    public Vector<Fabricante> view(Vector<Condition> conditions) throws SQLException {
        return this.find(conditions);
    }

    public Vector<Fabricante> view(Condition condition) throws SQLException {
    ...
    @Override
    public Vector<Fabricante> view() throws SQLException {
        Vector<Condition> conditions = new Vector<Condition>();
        return this.view(conditions);
    }
    @Override
