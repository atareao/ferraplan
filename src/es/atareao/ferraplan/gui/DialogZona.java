 ...
 */
public class DialogZona extends javax.swing.JDialog {
    //
    //********************************CONSTANTES********************************
    //
     ...
     */
    public DialogZona(JFrame padre,int operacion,Zona zona) throws SQLException {
        super(padre,true);
        initComponents();
        ...
        switch (operacion){
            case OP_ADD:
                this.setTitle("Añadir Zona");
                break;
            case OP_EDIT:
                this.setTitle("Editar Zona");
                break;
            case OP_DELETE:
                this.setTitle("Borrar Zona");
                this.doNotEditable();
                break;
            case OP_VIEW:
                this.setTitle("Consultar Zona");
                this.doNotEditable();
                break;
        }
        //
    ...
    public DialogZona(int operacion,Zona zona) throws SQLException{
        this(new JFrame(),operacion,zona);
    }
...
// TODO add your handling code here:
    ...
    private Zona fromDialog(){
        String nombre=jNombre.getText();
        this.getZona().setValue("NOMBRE",nombre);
        return this.getZona();
    }
    private void toDialog(Zona zona){
        String nombre=zona.getValue("NOMBRE");
