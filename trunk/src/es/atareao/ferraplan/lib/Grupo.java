...
public class Grupo  extends WrapperTable<Grupo>{
    //
    //********************************CONSTANTES********************************
    //
     ...
     */
    public Grupo(Conector conector) throws SQLException {
        super(Grupo.class,conector, "public", "grupo");
    ...
    //********************************METODOS***********************************
    //
    public Vector<Grupo> view(Vector<Condition> conditions) throws SQLException {
        return this.find(conditions);
    }

    public Vector<Grupo> view(Condition condition) throws SQLException {
    ...
    @Override
    public Vector<Grupo> view() throws SQLException {
        Vector<Condition> conditions = new Vector<Condition>();
        return this.view(conditions);
    }
    @Override
