...
public class Hormigon  extends WrapperTable<Hormigon>{
    //
    //********************************CONSTANTES********************************
    //
    ...
    //******************************CONSTRUCTORES*******************************
    //
    public Hormigon() throws SQLException {
        this(null);
    }
     ...
     */
    public Hormigon(Conector conector) throws SQLException {
        super(Hormigon.class,conector, "public", "hormigon");
    ...
    //********************************METODOS***********************************
    //
    public Vector<Hormigon> view(Vector<Condition> conditions) throws SQLException {
        return this.find(conditions);
    }

    public Vector<Hormigon> view(Condition condition) throws SQLException {
    ...
    @Override
    public Vector<Hormigon> view() throws SQLException {
        Vector<Condition> conditions = new Vector<Condition>();
        return this.view(conditions);
    }
    @Override
