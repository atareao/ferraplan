 ...
 * @author  Protactino
 */
public class DialogViga extends javax.swing.JDialog {
    //
    //********************************CONSTANTES********************************
    //
     ...
     */
    public DialogViga(JFrame padre, Revision revision){
        super(padre,true);
        initComponents();
        this.setSize(640, 870);
        ...
        try {
            _svgdoc = this.getSVGDocument(FileUtils.readTextFromJar("/es/atareao/ferraplan/img/viga_ink.svg"));
            this.dibuja();
    ...
    public DialogViga(Revision revision) throws SQLException{
    ...
    private void initComponents() {
        ...
        jAnclajeIzquierda = new javax.swing.JCheckBox();
        jAnclajeDerecha = new javax.swing.JCheckBox();
        ...
        jAnclajeIzquierda.setText("Anclaje por la Izquierda");
        jAnclajeIzquierda.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                dibuja(evt);
            }
        });
        jPanel2.add(jAnclajeIzquierda, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, 210, -1));

        jAnclajeDerecha.setText("Anclaje por la Derecha");
        jAnclajeDerecha.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                dibuja(evt);
            }
        });
        jPanel2.add(jAnclajeDerecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 40, 210, -1));
        ...
        jPanel2.add(jEstribos, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 70, 210, -1));

        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 290, 130));

        jPanel14.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Dimensiones viga:"));
        jPanel14.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel26.setText("cm");
        jPanel14.add(jLabel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 20, 30, 30));

        jLabel27.setText("Profundo (Y):");
        jPanel14.add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 100, 30));

        jLabel30.setText("cm");
        jPanel14.add(jLabel30, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 60, 30, 30));

        jLabel37.setText("Ancho (X):");
        jPanel14.add(jLabel37, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 100, 30));

        jLabel8.setText("Largo (Z):");
        jPanel14.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, 100, 30));

        jLabel9.setText("cm");
        jPanel14.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 100, 30, 30));

        jAnchoPilar.setInputVerifier(new GuiPositiveValidator(this,this.jAnchoPilar));
        jPanel14.add(jAnchoPilar, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 20, 110, 30));

        jLargoPilar.setInputVerifier(new GuiPositiveValidator(this,this.jLargoPilar));
        jPanel14.add(jLargoPilar, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 60, 110, 30));

        jAlto.setInputVerifier(new GuiPositiveValidator(this,this.jAlto));
        jPanel14.add(jAlto, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 100, 110, 30));

        jPanel1.add(jPanel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 10, 280, 140));
        ...
        jPanel1.add(jPanel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 150, 570, 60));
        ...
        jPanel1.add(jPanel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 210, 570, 60));

        jPanel16.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(), "Armado Profundo (Y):"));
        ...
        jPanel1.add(jPanel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 270, 570, 60));
        ...
        jPanel1.add(jPanel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 330, 570, 60));
        ...
        jPanel1.add(jPanel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 390, 570, 60));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 320, 600, 460));
        ...
        getContentPane().add(jAceptar, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 780, 50, 50));
        ...
        getContentPane().add(jCancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 780, 50, 50));
...
// TODO add your handling code here:
    ...
    private javax.swing.JCheckBox jAnclajeDerecha;
    private javax.swing.JCheckBox jAnclajeIzquierda;
    ...
    private void dibuja(){
        ...
        boolean anclaje_izquierda=this.jAnclajeIzquierda.isSelected();
        boolean anclaje_derecha=this.jAnclajeDerecha.isSelected();
        elemento_visible("estribos",estribos);
        this.setEnabled(this.jPanel20,estribos);
        elemento_visible("anclaje_izquierda",anclaje_izquierda);
        elemento_visible("anclaje_derecha",anclaje_derecha);
    ...
    private void doClose(int retStatus) {
        if(retStatus==RET_OK){
            if(valida()){
                ...
                String cod="";
                double factor=0.0;
                if(this.jAnclajeDerecha.isSelected()){
                    factor=1.0;
                }
                if(this.jAnclajeIzquierda.isSelected()){
                    factor+=1.0;
                }
                cod="V"+StringUtils.rellena(Convert.toString(contador++),"00");
                this.addBarra(cod,"1",(Diametro)this.jArmaduraPilarAnchoDiametro.getSelectedItem(),2.0*this.jArmaduraPilarAnchoNumero.getDouble(),"Longitudinales cara ancho (viga)",this.jAlto.getDouble()+factor*this.jArmaduraPilarLongitudAnclajeAncho.getDouble(),0,0,0,0,0,0,0,0,0);
                cod="V"+StringUtils.rellena(Convert.toString(contador++),"00");
                this.addBarra(cod,"1",(Diametro)this.jArmaduraPilarLargoDiametro.getSelectedItem(),2.0*this.jArmaduraPilarLargoNumero.getDouble(),"Longitudinales cara profundo (viga)",this.jAlto.getDouble()+factor*this.jArmaduraPilarLongitudAnclajeLargo.getDouble(),0,0,0,0,0,0,0,0,0);
                cod="V"+StringUtils.rellena(Convert.toString(contador++),"00");
                this.addBarra(cod,"1",(Diametro)this.jArmaduraPilarEsquinasDiametro.getSelectedItem(),4.0*this.jArmaduraPilarEsquinasNumero.getDouble(),"Longitudinales esquinas (viga)",this.jAlto.getDouble()+factor*this.jArmaduraPilarLongitudAnclajeEsquinas.getDouble(),0,0,0,0,0,0,0,0,0);
                if(this.jEstribos.isSelected()){
                    ...
                    this.addBarra(cod,"59",(Diametro)this.jArmaduraPilarEstribosDiametro.getSelectedItem(),this.jArmaduraPilarEstribosNumero.getDouble(),"Estribos (viga)",this.jAnchoPilar.getDouble()-2.0*this.jRecubrimiento.getDouble(),this.jLargoPilar.getDouble()-2.0*this.jRecubrimiento.getDouble(),patilla,0,0,0,0,0,0,0);
                }
            }else{
                return;
            }
